...
# sprite
SRC +=	$(SPRIT_DIR)/sprites.c \
				$(SPRIT_DIR)/sprites_loader.c \
				$(SPRIT_DIR)/sprites_utils.c

# utils
SRC +=	$(UTILS_DIR)/exit.c \
				$(UTILS_DIR)/exit_free.c \
				$(UTILS_DIR)/ft_split_set.c \
				$(UTILS_DIR)/init_load_ts.c \
				$(UTILS_DIR)/init_game.c
