...
char	**get_map(void)
{
	...
	map[1] = "11111111100000000000001";
	map[2] = "11111111100000000000001";
	map[3] = "10000011111110100000001";
	map[4] = "10000000000000100000001";
	map[5] = "10000111000000000000001";
	map[6] = "10000111000000000000001";
	map[7] = "10000000000000100000001";
	map[8] = "10000000000000100000001";
